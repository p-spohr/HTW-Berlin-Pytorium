...
# 1.5 Drucken Sie jede Name als ungekehrt aus.


# 1.6 Löschen Sie alle Elemente in der Liste.
...
# 2.3 Drucken Sie jede gerade Zahl aus.


# 2.4 Drucken Sie jede ungerade Zahl doppelt aus.
...
'''
Benutzen Sie die Namen von früher plus vier mehr. 
Das Alter ist 5 mal die Anzahl der Buchstaben.
Alle Leute mit ein 'a' in ihrem Name hat ein Hund, sonst Katze
'''
