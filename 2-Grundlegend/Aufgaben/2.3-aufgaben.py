...
## 2.2 Erweitern Sie die Funktion mit einer Farbe- und Muster-Parameter
...
## 3.2 BONUS: Wie Können Sie die Funktion erweitern, damit sie eine beliebige Anzahl von Zufallsvariablen berechnen kann.
